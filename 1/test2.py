...
sleep(1)
browser.get("https://www.soscuisine.com/")
browser.find_element_by_id("signInUpButton").click()
sleep(1)
browser.find_element_by_css_selector("input[type='text'][placeholder='Email / Username']").send_keys("nadia.tahiri@gmail.com")
browser.find_element_by_css_selector("button[type='submit']").click()
sleep(1)
browser.find_element_by_css_selector("input[type='password'][placeholder='Password']").send_keys("Escher1ch1a")
browser.find_element_by_class_name("button[type='submit']").click()
sleep(2)

browser.get("https://www.soscuisine.com/grocery-flyers/")
sleep(5)
browser.refresh()
sleep(2)
...
for key, value in regionsIds_dic.items():
    ...
    for lg in ("en", "fr"):
        if lg == "en":
            ...
            file_object = open("./soscuisine_"+ id_database + "_en.html", "w+")
            ...
            html = browser.page_source
            file_object = open("./soscuisine_"+ id_database + "_fr.html", "w+")
            file_object.write(html)
            file_object.close()
...
file_csv = open("./soscuisine.csv", "w+")
