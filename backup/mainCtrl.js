						 ...
						 $scope.$on('handleUser', function(events,user) {
							...
							if (!google_map_loaded) {
								...
								try {
									...
									script.src = "http://maps.googleapis.com/maps/api/js?libraries=geometry&language="+$scope.langage+"&key=AIzaSyDuTDLzojQ5XPa2SYanMJbJ_72yuwiPxgU&callback=loadMap";
...
console.log("ADRESSE USERRRRRRRRRRRRRRRRRRrr "+$scope.postalCode);
